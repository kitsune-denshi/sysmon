...
{
    // SCS INTOSC; SPLLMULT 4xPLL; SPLLEN disabled; IRCF 4MHz_HF; 
    OSCCON = 0x36;
    // SOSCR disabled; PLLRDY disabled; LFIOFR disabled; OSTS intosc; HFIOFS not0.5percent_acc; HFIOFR disabled; 
    OSCSTAT = 0x00;
    // TUN 0x0; 
    OSCTUNE = 0x00;
